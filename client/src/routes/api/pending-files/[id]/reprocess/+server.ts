...
export const POST: RequestHandler = async ({ params }) => {
  try {
    ...
    console.info(`🔄 [REPROCESS] Reprocesando archivo ID ${id}: ${pendingFile.originalFilename}`);
    ...
    console.info(`✅ [REPROCESS] Archivo reprocesado exitosamente (conf: ${result.confidence}%)`);
