    ...
    <div class="annotation-workspace">
        ...
        <div class="field-selector">
          ...
          {#each fieldOptions as option}
            <label class="field-option">
              <input type="radio" name="field" value={option.value} bind:group={selectedField} />
        ...
        <div class="zones-list">
          ...
          {:else}
            {#each zones as zone, i}
              <div class="zone-item">
                <div class="zone-info">
                  <span class="zone-color" style="background-color: {getFieldColor(zone.field)}"
                  ></span>
                  <div class="zone-details">
                    ...
                    {#if zone.extractedValue || getExtractedValue(zone.field)}
                      <span class="zone-value"
                        >"{zone.extractedValue || getExtractedValue(zone.field)}"</span
                      >
                    {/if}
                  </div>
                </div>
      ...
      <div class="canvas-container">
        <div class="instructions">
          <p>
            <strong>Instrucciones:</strong> Seleccione un campo a la izquierda y luego arrastre sobre
            la imagen para dibujar un rectángulo sobre el valor correspondiente.
          </p>
        </div>
        <canvas
          bind:this={canvas}
